...
fn presetPalette(preset: ThemePreset) Theme {
    return switch (preset) {
        .dark => .{
            ...
            .tab_width = 4,
            .colors = .{
                .workbench_bg = .{ .r = 0.117, .g = 0.117, .b = 0.117 },
                .header_bg = .{ .r = 0.2, .g = 0.2, .b = 0.2 },
                .activity_bg = .{ .r = 0.2, .g = 0.2, .b = 0.2 },
                .sidebar_bg = .{ .r = 0.125, .g = 0.125, .b = 0.13 },
                .agent_bg = .{ .r = 0.145, .g = 0.145, .b = 0.15 },
                .editor_bg = .{ .r = 0.117, .g = 0.117, .b = 0.117 },
                .tab_bar_bg = .{ .r = 0.12, .g = 0.12, .b = 0.12 },
                .tab_active_bg = .{ .r = 0.117, .g = 0.117, .b = 0.117 },
                .panel_bg = .{ .r = 0.117, .g = 0.117, .b = 0.117 },
                .status_bg = .{ .r = 0.0, .g = 0.48, .b = 0.8 },
