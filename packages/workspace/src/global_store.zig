...
pub fn ensureLayout(io: std.Io) !void {
    ...
    var file = std.Io.Dir.openFileAbsolute(io, settings_path, .{}) catch {
        const default_settings =
            ...
            \\custom_embedding_models = "nomic-embed-text|Nomic Embed (Ollama)|ollama,text-embedding-004|Gemini Embedding 004|gemini,nvidia/llama-nemotron-embed-vl-1b-v2:free|NVIDIA Llama Nemotron Embed (OpenRouter)|openrouter"
            \\
            \\[ghost_completion]
            \\provider = "ollama"
