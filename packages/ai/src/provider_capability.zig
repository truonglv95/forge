...
pub const builtin_models = [_]ModelCapability{
    ...
    .{
        ...
        .capability = .{
            ...
            .notes = "NVIDIA NIM endpoints — free tier",
        },
        .strengths = &.{ "code_edit", "completion" },
        .effective_context_tokens = 120_000,
    },
    // Z.AI (GLM) — pre-authenticated via /etc/.z-ai-config, free in dev
    .{
        .provider = "zai",
        .model_id = "glm-4-plus",
        .display_name = "GLM-4-Plus (Z.AI)",
        .capability = .{
            .max_context_tokens = 128_000,
            .supports_tools = true,
            .supports_streaming = true,
            ...
            .notes = "Pre-auth via /etc/.z-ai-config — free in dev sessions",
        },
        .strengths = &.{ "code_edit", "completion", "agentic", "planning" },
        .effective_context_tokens = 120_000,
    },
    .{
        .provider = "zai",
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Latest 4.5 generation — pre-auth, free in dev",
        },
    ...
    .{
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Latest 4.6 generation — pre-auth, free in dev",
        },
        .strengths = &.{ "code_edit", "completion", "agentic" },
        .effective_context_tokens = 120_000,
    },
    ...
    .{
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Reasoning model (chain-of-thought) — pre-auth, free in dev",
        },
    ...
    .{
        ...
        .display_name = "GLM-Zero Preview (Z.AI)",
        .capability = .{
            .max_context_tokens = 128_000,
            .supports_tools = true,
            .supports_streaming = true,
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Preview reasoning model — pre-auth, free in dev",
        },
        .strengths = &.{ "planning", "code_review", "agentic" },
        .effective_context_tokens = 120_000,
    },
    .{
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Long-context (1M tokens) — pre-auth, free in dev",
        },
        .strengths = &.{ "code_edit", "code_review", "explore_codebase" },
        .effective_context_tokens = 900_000,
    },
    // Groq (free tier, LPU-accelerated)
    .{
        .provider = "groq",
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Free tier: 30 RPM, 14k req/day, ~500 tok/s on LPU",
        },
        .strengths = &.{ "code_edit", "completion", "agentic" },
        .effective_context_tokens = 120_000,
    },
    ...
    .{
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Free tier, reasoning model (R1 distill)",
        },
        .strengths = &.{ "planning", "code_review", "agentic" },
        .effective_context_tokens = 120_000,
    },
    .{
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Free tier, code-specialized",
        },
        .strengths = &.{ "code_edit", "completion" },
        .effective_context_tokens = 120_000,
    },
    // Cerebras (free tier, wafer-scale)
    .{
        .provider = "cerebras",
        ...
        .capability = .{
            ...
            .price_per_mtok_input = 0,
            .price_per_mtok_output = 0,
            .notes = "Free tier: 30 RPM, ~1M tok/day, ~2000 tok/s on CS-3 wafer",
        },
        .strengths = &.{ "code_edit", "completion", "agentic" },
        .effective_context_tokens = 120_000,
    },
