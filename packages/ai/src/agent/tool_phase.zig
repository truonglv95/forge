...
pub const Input = struct {
    ...
    /// 0 means no step cap in the native tool loop.
    max_steps: u32,
...
pub fn runNative(
    ...
    const state = try runTransport(
        ...
        .{
            ...
            .initial_task_ledger_json = input.initial_task_ledger_json,
            ...
            .telemetry_callback = input.telemetry_callback,
            .telemetry_context = input.telemetry_context,
            .rate_limit_callback = input.rate_limit_callback,
            .rate_limit_context = input.rate_limit_context,
            .max_rate_limit_retries = input.max_rate_limit_retries,
