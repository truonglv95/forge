...
pub fn drawExplorerPanel(wb: *Workbench, explorer_x: f32, explorer_panel_width: f32, h: f32) void {
    ...
    shared.drawSidebarScrollbar(explorer_x, explorer_panel_width, explorer_scroll.list_top, h, wb.explorer_scroll_y, visible.items.len, explorer_scroll.row_height);
}
