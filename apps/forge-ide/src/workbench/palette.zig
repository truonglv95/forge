...
pub const Palette = struct {
    ...
    pub fn rebuildCatalog(self: *Palette) !void {
        ...
        const builtins = [_]Entry{
            ...
            .{ .id = "git.pull", .title = "Git: Pull", .category = "Git", .command = .git_pull },
            .{ .id = "git.push", .title = "Git: Push", .category = "Git", .command = .git_push },
            .{ .id = "git.stage_all", .title = "Git: Stage All Changes", .category = "Git", .command = .git_stage_all },
            .{ .id = "git.unstage_all", .title = "Git: Unstage All", .category = "Git", .command = .git_unstage_all },
            .{ .id = "git.stash", .title = "Git: Stash Changes", .category = "Git", .command = .git_stash },
            .{ .id = "git.stash_pop", .title = "Git: Pop Stash", .category = "Git", .command = .git_stash_pop },
            .{ .id = "git.create_branch", .title = "Git: Create New Branch", .category = "Git", .command = .git_create_branch },
            .{ .id = "git.log", .title = "Git: Show Commit Log", .category = "Git", .command = .git_log },
            .{ .id = "git.blame", .title = "Git: Toggle Blame Annotations", .category = "Git", .command = .git_blame },
            ...
            .{ .id = "diff.open", .title = "Git: Open Diff View", .category = "Git", .command = .{ .diff_open = "" } },
            .{ .id = "profile.save", .title = "Profile: Save Current Layout", .category = "Profile", .command = .profile_save },
            .{ .id = "profile.load", .title = "Profile: Load Saved Layout", .category = "Profile", .command = .profile_load },
            .{ .id = "terminal.split", .title = "Terminal: Toggle Split", .category = "Terminal", .command = .terminal_split },
            .{ .id = "terminal.focus_switch", .title = "Terminal: Switch Focus Between Panes", .category = "Terminal", .command = .terminal_focus_switch },
            .{ .id = "keybinding.open_editor", .title = "Preferences: Open Keyboard Shortcuts", .category = "Preferences", .command = .keybinding_open_editor },
            .{ .id = "extension.open_settings", .title = "Extensions: Open Extension Settings", .category = "Extensions", .command = .extension_open_settings },
            .{ .id = "ai.fix_diagnostic", .title = "AI: Fix This Error", .category = "AI", .command = .ai_fix_diagnostic },
            .{ .id = "ai.implement_todo", .title = "AI: Implement This TODO", .category = "AI", .command = .ai_implement_todo },
            .{ .id = "ai.review_selection", .title = "AI: Review Selected Code", .category = "AI", .command = .ai_review_selection },
            .{ .id = "ai.toggle_proactive", .title = "AI: Toggle Proactive Completion", .category = "AI", .command = .ai_toggle_proactive_completion },
            .{ .id = "ai.auto_context", .title = "AI: Auto-Include Active File Context", .category = "AI", .command = .ai_auto_context },
            .{ .id = "undo.history", .title = "View: Show Undo History", .category = "View", .command = .undo_history_show },
            .{ .id = "semantic.search", .title = "Search: Semantic Search (NL)", .category = "Search", .command = .semantic_search_panel },
            ...
            .{ .id = "ext.open.user", .title = "Extensions: Open User Folder", .category = "Extensions", .command = .{ .open_extensions_dir = "" } },
